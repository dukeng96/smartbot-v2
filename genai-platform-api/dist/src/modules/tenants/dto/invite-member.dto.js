...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'newmember@example.com' }),
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
], InviteMemberDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['admin', 'member', 'viewer'], default: 'member' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['admin', 'member', 'viewer']),
    __metadata("design:type", String)
