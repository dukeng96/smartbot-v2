...
exports.ConversationsModule = ConversationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [conversations_service_1.ConversationsService, messages_service_1.MessagesService],
        exports: [conversations_service_1.ConversationsService, messages_service_1.MessagesService],
    })
], ConversationsModule);
