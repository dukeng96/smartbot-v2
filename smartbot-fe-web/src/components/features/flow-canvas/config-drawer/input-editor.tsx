...
import { ConditionsArrayEditor } from "./conditions-array-editor"
import { IntentsArrayEditor } from "./intents-array-editor"
import type { NodeInputDefinition, MessageEntry, StateUpdate, ConditionRule, Intent } from "@/lib/types/flow"
...
export function InputEditor({ input, value, nodeId, onChange, allConfig }: InputEditorProps) {
  ...
  return (
    <div className="space-y-1">
      ...
      {input.type === "intents_array" && (
        <IntentsArrayEditor
          value={(value as Intent[]) ?? []}
          onChange={onChange}
        />
      )}
